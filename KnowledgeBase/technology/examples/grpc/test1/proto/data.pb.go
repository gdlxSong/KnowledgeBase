...
var file_data_proto_rawDesc = []byte{
	...
	0x32, 0x38, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x2d, 0x0a, 0x0a, 0x47,
	0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74,
...
var file_data_proto_depIdxs = []int32{
	0, // 0: proto.Message.GetMessage:input_type -> proto.Request
	1, // 1: proto.Message.GetMessage:output_type -> proto.Response
...
func (c *messageClient) GetMessage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Message/GetMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMessageServer) GetMessage(context.Context, *Request) (*Response, error) {
...
func _Message_GetMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Message/GetMessage",
	}
